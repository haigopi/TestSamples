...
public class ObjectMapperBase {
	...
	protected Map<String, Object> buildListBasedMap(Boolean isSuccess, String listType, List<?> list) {
	...
	protected Map<String, Object> buildObjectBasedMap(Boolean isSuccess, String listType, Object obj) {
		HashMap<String, Object> myMap = new HashMap<String, Object>();
	...
	protected Map<String, Object> buildSessionExpiredJsonMap(Boolean isSuccess, String exceptionMessage) {
		HashMap<String, Object> myMap = (HashMap<String, Object>) buildSuccessPropertyBasedMap(
				isSuccess, exceptionMessage);
