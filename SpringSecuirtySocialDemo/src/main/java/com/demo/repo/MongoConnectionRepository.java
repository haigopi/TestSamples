...
public class MongoConnectionRepository implements ConnectionRepository {
    ...
    public MultiValueMap<String, Connection<?>> findAllConnections() {
        List<MongoConnection> userSocialConnectionList = this.userSocialConnectionRepository
                .findByUserId(userId);
        ...
        for (MongoConnection userSocialConnection : userSocialConnectionList) {
    ...
    public MultiValueMap<String, Connection<?>> findConnectionsToUsers(MultiValueMap<String, String> providerUsers) {
        ...
        for (Iterator<Map.Entry<String, List<String>>> it = providerUsers.entrySet().iterator(); it.hasNext();) {
            ...
            List<MongoConnection> userSocialConnections =
            ...
            for (MongoConnection userSocialConnection : userSocialConnections) {
    ...
    public Connection<?> getConnection(ConnectionKey connectionKey) {
        MongoConnection userSocialConnection = this.userSocialConnectionRepository
    ...
    public void addConnection(Connection<?> connection) {
        ...
        if (socialAuthenticationService.getConnectionCardinality() == SocialAuthenticationService.ConnectionCardinality.ONE_TO_ONE ||
            ...
            List<MongoConnection> storedConnections =
        ...
        if (userSocialConnection == null) {
            ...
            userSocialConnection = new MongoConnection(userId, data.getProviderId(), data.getProviderUserId(), 0,
    ...
    private Connection<?> buildConnection(MongoConnection userSocialConnection) {
