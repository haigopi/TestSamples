package com.demo.controllers.util;
...
public class SocialControllerUtil {
    ...
    public MongoConnection getUserConnection(HttpSession session, String userId) {
        ...
        if (connection == null || !userId.equals(connection.getProviderId())) {
            connection = usersDao.getUserConnection(userId, connection);
     ...
     * @return
     */
    protected String getDisplayName(MongoConnection connection, UserProfile profile) {
